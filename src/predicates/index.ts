...
export const isClass = (value) => (isFunction(value) && isPropertyOwned(value, "prototype") && value.prototype && isPropertyOwned(value.prototype, "constructor") && value.prototype.constructor.toString().substring(0, 5) === "class");
...
export const isEmptyString = (str) => typeof str === "string" && /^\s*$/.test(str); //eslint-disable-line
...
export const isPrefix = (prefix, str) => getTagSimple(str) === "str" && str.startsWith(prefix);

// Checks whether `str` ends with `suffix`.
export const isSuffix = (suffix, str) => getTagSimple(str) === "str" && str.endsWith(suffix);
...
export const isDate = (value) => getTagSimple(value) === "date";
...
export const isPrimitive = (value) => isNil(value) || isNumber(value) || typeof value === "string" || isBoolean(value) || isSymbol(value); //eslint-disable-line

export const isEqual = (value, other) => (value === other || (value !== value && other !== other));
...
export const isJson = (value) => (typeof value === "string" && value.endsWith(".json")) || isObject(value); //eslint-disable-line

export const isNamespace = (value) => isObject(value) && value[asNamespace.SYMBOL] === true;
...
export const isConforms = (obj, schema, strict) => {
...
export const isInArray = (value, array, offset, comparator) => {
...
export const isStream = (value) => (value !== null && typeof value === "object" && isFunction(value.pipe));
export const isWritableStream = (value) => isStream(value) && typeof value._writableState === "object";
export const isReadableStream = (value) => isStream(value) && typeof value._readableState === "object";
export const isDuplexStream = (value) => isWritableStream(value) && isReadableStream(value);
export const isTransformStream = (value) => isStream(value) && typeof value._transformState === "object";
...
export const isPosixPathAbsolute = (path) => path.charAt(0) === "/";
export const isWin32PathAbsolute = (path) => {
...
export const isBinaryExtension = (x) => binaryExtensions.has(x);
export const isBinaryPath = (x) => binaryExtensions.has(path.extname(x).slice(1).toLowerCase());
