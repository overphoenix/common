...
const propertyOwned = (obj: any, field: string) =>
  hasOwnProperty.call(obj, field);

const isClass = (value: any) =>
  typeof value === 'function' &&
  propertyOwned(value, 'prototype') &&
  value.prototype &&
  propertyOwned(value.prototype, 'constructor') &&
...
export function typeOf(obj: any): string {
  ...
  if (typeofObj !== 'object') {
    return isClass(obj) ? 'class' : typeofObj;
  } else if (obj === null) {
    /* ! Speed optimisation
     * Pre:
    ...
    // eslint-disable-line ateos/no-array-isarray
    /* ! Speed optimisation
     * Pre:
